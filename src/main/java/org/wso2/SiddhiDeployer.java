...
public class SiddhiDeployer {
    ...
    public static void main(String[] args) {
        ...
        String siddiAppString14 = "@App:name('TestPlan') \n" +
        ...
        SiddhiAppSplitter siddhiAppSplitter = new SiddhiAppSplitter();
        siddhiAppSplitter.distributeSiddiApp(siddiAppString14);
